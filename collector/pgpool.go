 ...
 *
 *     4.3, 4.4 (14) node_id, hostname, port, status, pg_status, lb_weight,
 ...
 *     4.0, 4.1 not present
 *
 *     4.2, 4.3, 4.4 (20) node_id, hostname, port, status, role,
 ...
 *     4.0, 4.1 not present
 *
 *     4.2, 4.3, 4.4 (14) node_id, hostname, port, status, role, select_cnt,
 ...
 *
 *     4.3, 4.4 (9) num_cache_hits, num_selects, cache_hit_ratio,
 *     num_hash_entries, used_hash_entries, num_cache_entries,
